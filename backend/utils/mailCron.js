...
//           if(user.applyAutomatically){
//             console.log("Applied for the post automatically");
...
//           if (user.applyAutomatically) {
//             try {
//               console.log("Applying for the post automatically");
//               await applyForJob({ jobId: job._id, user });
//               console.log("Applied for the post automatically");
//             } catch (error) {
//               console.error(`Failed to apply automatically for user ${user._id}:`, error.message);
//             }
//           }
//         }
//         job.newsLettersSent = true;
