...
const Register = () => {
  ...
  const handleRegsiter = (e) => {
    ...
    if (role === "Job Seeker") {
      ...
      formData.append("applyAutomatically",applyAutomatically);
    }
          ...
          <form onSubmit={handleRegsiter}>
            ...
            {role === "Job Seeker" && (
              <>
                ...
                <div className="wrapper">
                  <label>Apply for upcoming jobs automatically</label>
                  <input value={applyAutomatically} type="checkbox"  onChange={(e) => setApplyAutomatically(e.target.checked)} />  
                </div>
              </>
            )}
